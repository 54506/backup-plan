...
const hubs = [
    {
        city: 'Noida',
        label: 'Sector 62 IT Park',
        role: 'Business Support',
        description: 'Providing structured BPO and non-voice processes from the heart of Noida’s IT corridor.',
    ...
    {
        city: 'Indore',
        label: 'Vijay Nagar Business District',
        role: 'Support Hub',
    ...
    {
        city: 'Hyderabad',
        label: 'HITEC City, Madhapur',
        role: 'Head Office & Tech',
        description: 'Our primary hub for software development, IT applications, and international voice operations.',
    ...
    {
        city: 'Chennai',
        label: 'Tidel Park, Taramani',
        role: 'Operational Hub',
        description: 'Dedicated team delivery and large-scale workforce management for customer engagement.',
    ...
    {
        city: 'Bangalore',
        label: 'Whitefield ITPL Road',
        role: 'Tech & Software Center',
        description: 'Focused on developing and scaling our proprietary OPMW HRMS and custom enterprise apps.',
